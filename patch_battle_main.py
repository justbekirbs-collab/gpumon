...
old_func = """void DownloadGPU_NativeFunc(void)
{
...
new_func = """
extern void PokemonToBattleMon(struct Pokemon *src, struct BattlePokemon *dst);
...
with open(filepath, "w") as f:
    f.write(content)
print("Patched DownloadGPU_NativeFunc")
