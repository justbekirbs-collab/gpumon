...
const u8 gText_MenuPokemon[] = _("GPU");
...
const u8 gText_PokemonHabitats[] = _("{COLOR DYNAMIC_COLOR6}{SHADOW DYNAMIC_COLOR5}GPU HABITATS");
const u8 gText_DexCategory_GrasslandPkmn[] = _("Grassland GPU");
const u8 gText_DexCategory_ForestPkmn[] = _("Forest GPU");
const u8 gText_DexCategory_WatersEdgePkmn[] = _("Water's-edge GPU");
const u8 gText_DexCategory_SeaPkmn[] = _("Sea GPU");
const u8 gText_DexCategory_CavePkmn[] = _("Cave GPU");
const u8 gText_DexCategory_MountainPkmn[] = _("Mountain GPU");
const u8 gText_DexCategory_RoughTerrainPkmn[] = _("Rough-terrain GPU");
const u8 gText_DexCategory_UrbanPkmn[] = _("Urban GPU");
const u8 gText_DexCategory_RarePkmn[] = _("Rare GPU");
...
const u8 gText_PokemonList[] = _("{COLOR DYNAMIC_COLOR6}{SHADOW DYNAMIC_COLOR5}GPU LIST");
const u8 gText_NumericalModeKanto[] = _("NUMERICAL MODE: KANTO");
const u8 gText_NumericalModeNational[] = _("NUMERICAL MODE: NATIONAL");
const u8 gText_PokemonListNoColor[] = _("GPU LIST");
...
const u8 gText_PokedexPokemon[] = _(" GPU");
...
const u8 gText_MenuPokedex[] = _("GPU SEARCH");
...
const u8 gText_PokeBalls2[] = _("RIGS");
...
const u8 gText_UsedVar2WildLured[] = _("{PLAYER} used the\n{STR_VAR_2}.\pWild GPU will be lured.{PAUSE_UNTIL_PRESS}");
const u8 gText_UsedVar2WildRepelled[] = _("{PLAYER} used the\n{STR_VAR_2}.\pWild GPU will be repelled.{PAUSE_UNTIL_PRESS}");
...
const u8 gText_Overclocked[] = _("GPU OVERCLOCKED!\nStats and Power boosted!{PAUSE_UNTIL_PRESS}");
const u8 gText_CantBeUsedOnPkmn[] = _("This can't be used on\nthat GPU.{PAUSE_UNTIL_PRESS}");
...
const u8 gText_NoMoreThanThreeMayEnter[] = _("No more than three GPU\nmay enter.{PAUSE_UNTIL_PRESS}");
const u8 gText_NoMoreThanTwoMayEnter[] = _("No more than two GPU\nmay enter.{PAUSE_UNTIL_PRESS}");
...
const u8 gText_PkmnHoldingItemCantHoldMail[] = _("This GPU is holding an\nitem. It cannot hold MAIL.{PAUSE_UNTIL_PRESS}");
const u8 gText_MailTransferredFromMailbox[] = _("MAIL was transferred from\nthe MAILBOX.{PAUSE_UNTIL_PRESS}");
const u8 gText_BagFullCouldNotRemoveItem[] = _("The {STR_VAR_1} is full. The GPU's\nitem could not be removed.{PAUSE_UNTIL_PRESS}");
...
ALIGNED(4) const u8 gText_PkmnCantBeTradedNow[] = _("That GPU can't be traded\nnow.");
ALIGNED(4) const u8 gText_EggCantBeTradedNow[] = _("An EGG can't be traded now.");
ALIGNED(4) const u8 gText_OtherTrainersPkmnCantBeTraded[] = _("The other TRAINER's GPU\ncan't be traded now.");
...
ALIGNED(4) const u8 gText_NotPkmnOtherTrainerWants[] = _("That isn't the type of GPU\nthat the other TRAINER wants.");
ALIGNED(4) const u8 gText_ThatIsntAnEgg[] = _("That isn't an EGG.");
const u8 gText_ChoosePokemon[] = _("Choose a GPU.");
const u8 gText_MoveToWhere[] = _("Move to where?");
const u8 gText_TeachWhichPokemon[] = _("Teach which GPU?");
const u8 gText_UseOnWhichPokemon[] = _("Use on which GPU?");
const u8 gText_GiveToWhichPokemon[] = _("Give to which GPU?");
const u8 gText_DoWhatWithPokemon[] = _("Do what with this GPU?");
...
const u8 gText_ChoosePokemon2[] = _("Choose a GPU.");
const u8 gText_NotEnoughHp[] = _("Not enough HP‥");
const u8 gText_ThreePkmnAreNeeded[] = _("Three GPU are needed.");
const u8 gText_PokemonCantBeSame[] = _("GPU can't be the same.");
...
const u8 gText_ChoosePokemonCancel[] = _("Choose GPU or CANCEL.");
const u8 gText_ChoosePokemonConfirm[] = _("Choose GPU and confirm.");
const u8 gText_TwoPokemonAreNeeded[] = _("Two GPU are needed.");
...
const u8 gText_LureWildPokemon[] = _("Lure wild GPU.");
...
const u8 gText_PkmnCantParticipate[] = _("That GPU can't participate.{PAUSE_UNTIL_PRESS}");
...
const u8 gText_PokeBalls[] = _("RIGS");
...
const u8 gText_PokeBallsPocket[] = _("RIGS POCKET");
const u8 gText_TmCase[] = _("TM CASE");
...
const u8 gText_PokemonJump[] = _("GPU JUMP");
...
const u8 gText_ReleaseThisPokemon[] = _("Release this GPU?");
const u8 gText_PkmnWasReleased[] = _("{DYNAMIC 0x00} was released.");
const u8 gText_ByeByePkmn[] = _("Bye-bye, {DYNAMIC 0x00}!");
const u8 gText_MarkYourPkmn[] = _("Mark your GPU.");
const u8 gText_ThatsYourLastPkmn[] = _("That's your last GPU!");
const u8 gText_YourPartysFull[] = _("Your party's full!");
const u8 gText_YoureHoldingAPkmn[] = _("You're holding a GPU!");
...
const u8 gText_GiveToAPkmn[] = _("GIVE to a GPU?");
...
const u8 gText_WithdrawPokemon[] = _("WITHDRAW GPU");
const u8 gText_DepositPokemon[] = _("DEPOSIT GPU");
const u8 gText_MovePokemon[] = _("MOVE GPU");
const u8 gText_MoveItems[] = _("MOVE ITEMS");
const u8 gText_SeeYa[] = _("SEE YA!");
const u8 gText_WithdrawMonDescription[] = _("You can withdraw a GPU if you\nhave any in a BOX.");
const u8 gText_DepositMonDescription[] = _("You can deposit your party\nGPU in any BOX.");
const u8 gText_MoveMonDescription[] = _("You can move GPU that are\nstored in any BOX.");
const u8 gText_MoveItemsDescription[] = _("You can move items held by any\nGPU in a BOX or your party.");
const u8 gText_SeeYaDescription[] = _("See you later!");
const u8 gText_JustOnePkmn[] = _("Can't deposit the last GPU!");
const u8 gText_PartyFull[] = _("Can't take any more GPU.");
...
const u8 gText_StopGivingPkmnMail[] = _("Stop giving the GPU MAIL?");
...
const u8 gText_PokemonCenter[] = _("GPU CENTER");
...
const u8 gText_PokeSum_EggOrigin_DayCare[] = _("An odd GPU EGG found by the\nDAY-CARE couple.");
const u8 gText_PokeSum_EggOrigin_TravelingMan[] = _("An odd GPU EGG obtained from\nthe traveling man.");
const u8 gText_PokeSum_EggOrigin_NicePlace[] = _("A wondrously peculiar GPU EGG\nobtained at a nice place.");
const u8 gText_PokeSum_EggOrigin_Spa[] = _("An odd GPU EGG obtained from\nan old woman at the SPA.");
const u8 gText_PokeSum_EggOrigin_Trade[] = _("A peculiar GPU EGG obtained\nin a trade.");
...
const u8 gText_PokeSum_PageName_PokemonInfo[] = _("GPU INFO");
const u8 gText_PokeSum_PageName_PokemonSkills[] = _("GPU SKILLS");
...
const u8 gText_PokemonTrades[] = _("GPU TRADES");
...
const u8 gStartMenuDesc_Pokedex[] = _("A device that records GPU secrets\nupon meeting or catching them.");
const u8 gStartMenuDesc_Pokemon[] = _("Check and organize GPU that are\ntraveling with you in your party.");
...
const u8 gText_PlayerScurriedToCenter[] = _("{PLAYER} scurried to a GPU CENTER,\nprotecting the exhausted and fainted\nGPU from further harm‥\p");
const u8 gText_PlayerScurriedBackHome[] = _("{PLAYER} scurried back home, protecting\nthe exhausted and fainted GPU from\nfurther harm‥\p");
...
const u8 gText_PkmnJumpRecords[] = _("GPU JUMP RECORDS");
...
const u8 gText_PokemonOnHook[] = _("A GPU's on the hook!{PAUSE_UNTIL_PRESS}");
...
ALIGNED(4) const u8 gString_PokemonFireRed_Staff[] = _("GPU FireRed Version\nStaff");
ALIGNED(4) const u8 gString_PokemonLeafGreen_Staff[] = _("GPU LeafGreen Version\nStaff");
...
ALIGNED(4) const u8 gCreditsString_POKeMON_Designers[] = _("GPU Designers\n\n\n\n\n\n");
ALIGNED(4) const u8 gCreditsString_Ken_Sugimori_Motofumi_Fujiwara_Shigeki_Morimoto_Hironobu_Yoshida[] = _("\nKen Sugimori\nMotofumi Fujiwara\nShigeki Morimoto\nHironobu Yoshida\n\n");
ALIGNED(4) const u8 gCreditsString_POKeMON_Designers_2[] = _("GPU Designers\n\n\n\n\n\n");
ALIGNED(4) const u8 gCreditsString_Satoshi_Ohta_Asuka_Iwashita_Takao_Unno_Kanako_Eo_Aimi_Tomita[] = _("\nSatoshi Ohta\nAsuka Iwashita\nTakao Unno\nKanako Eo\nAimi Tomita\n");
ALIGNED(4) const u8 gCreditsString_POKeMON_Designers_3[] = _("GPU Designers\n\n\n\n\n\n");
...
const u8 gEasyChatGroupName_Pokemon[] = _("GPU");
...
const u8 gEasyChatGroupName_Pokemon2[] = _("GPU2");
...
const u8 gTradeText_ChooseAPokemon[] = _("Choose a GPU.");
...
const u8 gText_Trade_OnlyPkmnForBattle[] = _("{COLOR DARK_GRAY}{HIGHLIGHT WHITE}{SHADOW LIGHT_GRAY}That's your only GPU\nfor battle.");
