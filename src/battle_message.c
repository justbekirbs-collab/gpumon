...
static const u8 sText_UseNextPkmn[] = _("Use next GPU?");
...
static const u8 sText_FaintInThree[] = _("All affected GPU will\nfaint in three turns!");
...
static const u8 sText_ItDodgedBall[] = _("It dodged the thrown BALL!\nThis GPU can't be caught!");
static const u8 sText_YouMissedPkmn[] = _("You missed the GPU!");
...
static const u8 sText_PkmnHearingFluteAwoke[] = _("The GPU hearing the FLUTE\nawoke!");
static const u8 sText_YouThrowABallNowRight[] = _("You throw a BALL now, right?\nI… I'll do my best!");
const u8 gText_ForPetesSake[] = _("OAK: Oh, for Pete's sake…\nSo pushy, as always.\p{B_PLAYER_NAME}.\pYou've never had a GPU battle\nbefore, have you?\pA GPU battle is when TRAINERS\npit their GPU against each\lother.\p");
const u8 gText_TheTrainerThat[] = _("The TRAINER that makes the other\nTRAINER's GPU faint by lowering\ltheir HP to “0,” wins.\p");
