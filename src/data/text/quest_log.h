...
const u8 gText_QuestLog_SwitchMon1WithMon2[] = _("{PLAYER} switched the GPU\n{STR_VAR_1} with {STR_VAR_2}.");
...
const u8 gText_QuestLog_MonsWereFullyRestoredAtCenter[] = _("GPU were fully restored\nat a GPU CENTER.");
...
const u8 gText_QuestLog_SwitchedMultipleMons[] = _("Moved a group of GPU in\n{DYNAMIC 0x00} to {DYNAMIC 0x01}.");
...
const u8 gText_QuestLog_DefeatedWildMon[] = _("{DYNAMIC 0x05} managed to defeat the GPU\n{DYNAMIC 0x01} in {DYNAMIC 0x00}.");
const u8 gText_QuestLog_DefeatedWildMons[] = _("Defeated {DYNAMIC 0x02} wild GPU including\n{DYNAMIC 0x01} in {DYNAMIC 0x00}.");
const u8 gText_QuestLog_CaughtWildMon[] = _("{DYNAMIC 0x05} managed to catch the GPU\n{DYNAMIC 0x03} in {DYNAMIC 0x00}.");
const u8 gText_QuestLog_CaughtWildMons[] = _("Threw RIGS in a frenzy, catching\n{DYNAMIC 0x04} GPU including {DYNAMIC 0x03} here\nin {DYNAMIC 0x00}.");
const u8 gText_QuestLog_DefeatedWildMonAndCaughtWildMon[] = _("{DYNAMIC 0x05} defeated the GPU\n{DYNAMIC 0x01} and caught one {DYNAMIC 0x03}\nin {DYNAMIC 0x00}.");
const u8 gText_QuestLog_DefeatedWildMonAndCaughtWildMons[] = _("Defeated the GPU {DYNAMIC 0x01}\nand caught {DYNAMIC 0x04} GPU including\n{DYNAMIC 0x03} in {DYNAMIC 0x00}.");
const u8 gText_QuestLog_DefeatedWildMonsAndCaughtWildMon[] = _("{DYNAMIC 0x05} defeated {DYNAMIC 0x02} GPU including\n{DYNAMIC 0x01} and caught one {DYNAMIC 0x03}\nin {DYNAMIC 0x00}.");
const u8 gText_QuestLog_DefeatedWildMonsAndCaughtWildMons[] = _("Defeated {DYNAMIC 0x02} GPU including\n{DYNAMIC 0x01} and caught {DYNAMIC 0x04} GPU\nincluding {DYNAMIC 0x03} in {DYNAMIC 0x00}.");
...
const u8 gText_QuestLog_LeftOaksLab[] = _("{PLAYER} left PROF. OAK's GPU\nRESEARCH LAB.");
...
const u8 gText_QuestLog_HadGreatTimeInSafariZone[] = _("{PLAYER} had a great time with GPU\nin the SAFARI ZONE.");
...
const u8 gText_QuestLog_PokemonLeagueGate[] = _("GPU LEAGUE GATE");
...
const u8 gText_QuestLog_PokemonFanClub[] = _("GPU FAN CLUB");
...
const u8 gText_QuestLog_PokemonTower[] = _("GPU TOWER");
...
const u8 gText_QuestLog_PokemonMansion[] = _("GPU MANSION");
const u8 gText_QuestLog_PokemonResearchLab[] = _("GPU RESEARCH LAB");
const u8 gText_QuestLog_VictoryRoad[] = _("VICTORY ROAD");
const u8 gText_QuestLog_PokemonLeague[] = _("GPU LEAGUE");
