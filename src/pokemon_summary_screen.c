...
struct PokemonSummaryScreenData
{
    ...
    struct PokeSummary
    {
        ...
        u8 ALIGNED(4) statValueStrBufs[5][25];
...
static void PrintSkillsPage(void)
{
    ...
    {
        u8 buf[20];
        u8 colorRed[] = {EXT_CTRL_CODE_BEGIN, EXT_CTRL_CODE_COLOR, TEXT_COLOR_RED, EOS};
        u8 colorBlue[] = {EXT_CTRL_CODE_BEGIN, EXT_CTRL_CODE_COLOR, TEXT_COLOR_BLUE, EOS};

        StringCopy(buf, colorRed);
        ConvertIntToDecimalStringN(buf + 3, GetMonData(&sMonSummaryScreen->currentMon, MON_DATA_ATK_IV), STR_CONV_MODE_LEFT_ALIGN, 2);
        AddTextPrinterParameterized3(sMonSummaryScreen->windowIds[POKESUM_WIN_RIGHT_PANE], FONT_NORMAL, 85, 22, sLevelNickTextColors[0], TEXT_SKIP_DRAW, buf);

        ConvertIntToDecimalStringN(buf + 3, GetMonData(&sMonSummaryScreen->currentMon, MON_DATA_DEF_IV), STR_CONV_MODE_LEFT_ALIGN, 2);
        AddTextPrinterParameterized3(sMonSummaryScreen->windowIds[POKESUM_WIN_RIGHT_PANE], FONT_NORMAL, 85, 35, sLevelNickTextColors[0], TEXT_SKIP_DRAW, buf);

        ConvertIntToDecimalStringN(buf + 3, GetMonData(&sMonSummaryScreen->currentMon, MON_DATA_SPATK_IV), STR_CONV_MODE_LEFT_ALIGN, 2);
        AddTextPrinterParameterized3(sMonSummaryScreen->windowIds[POKESUM_WIN_RIGHT_PANE], FONT_NORMAL, 85, 48, sLevelNickTextColors[0], TEXT_SKIP_DRAW, buf);

        ConvertIntToDecimalStringN(buf + 3, GetMonData(&sMonSummaryScreen->currentMon, MON_DATA_SPDEF_IV), STR_CONV_MODE_LEFT_ALIGN, 2);
        AddTextPrinterParameterized3(sMonSummaryScreen->windowIds[POKESUM_WIN_RIGHT_PANE], FONT_NORMAL, 85, 61, sLevelNickTextColors[0], TEXT_SKIP_DRAW, buf);

        ConvertIntToDecimalStringN(buf + 3, GetMonData(&sMonSummaryScreen->currentMon, MON_DATA_SPEED_IV), STR_CONV_MODE_LEFT_ALIGN, 2);
        AddTextPrinterParameterized3(sMonSummaryScreen->windowIds[POKESUM_WIN_RIGHT_PANE], FONT_NORMAL, 85, 74, sLevelNickTextColors[0], TEXT_SKIP_DRAW, buf);

        StringCopy(buf, colorBlue);
        ConvertIntToDecimalStringN(buf + 3, GetMonData(&sMonSummaryScreen->currentMon, MON_DATA_ATK_EV), STR_CONV_MODE_LEFT_ALIGN, 3);
        AddTextPrinterParameterized3(sMonSummaryScreen->windowIds[POKESUM_WIN_RIGHT_PANE], FONT_NORMAL, 105, 22, sLevelNickTextColors[0], TEXT_SKIP_DRAW, buf);

        ConvertIntToDecimalStringN(buf + 3, GetMonData(&sMonSummaryScreen->currentMon, MON_DATA_DEF_EV), STR_CONV_MODE_LEFT_ALIGN, 3);
        AddTextPrinterParameterized3(sMonSummaryScreen->windowIds[POKESUM_WIN_RIGHT_PANE], FONT_NORMAL, 105, 35, sLevelNickTextColors[0], TEXT_SKIP_DRAW, buf);

        ConvertIntToDecimalStringN(buf + 3, GetMonData(&sMonSummaryScreen->currentMon, MON_DATA_SPATK_EV), STR_CONV_MODE_LEFT_ALIGN, 3);
        AddTextPrinterParameterized3(sMonSummaryScreen->windowIds[POKESUM_WIN_RIGHT_PANE], FONT_NORMAL, 105, 48, sLevelNickTextColors[0], TEXT_SKIP_DRAW, buf);

        ConvertIntToDecimalStringN(buf + 3, GetMonData(&sMonSummaryScreen->currentMon, MON_DATA_SPDEF_EV), STR_CONV_MODE_LEFT_ALIGN, 3);
        AddTextPrinterParameterized3(sMonSummaryScreen->windowIds[POKESUM_WIN_RIGHT_PANE], FONT_NORMAL, 105, 61, sLevelNickTextColors[0], TEXT_SKIP_DRAW, buf);

        ConvertIntToDecimalStringN(buf + 3, GetMonData(&sMonSummaryScreen->currentMon, MON_DATA_SPEED_EV), STR_CONV_MODE_LEFT_ALIGN, 3);
        AddTextPrinterParameterized3(sMonSummaryScreen->windowIds[POKESUM_WIN_RIGHT_PANE], FONT_NORMAL, 105, 74, sLevelNickTextColors[0], TEXT_SKIP_DRAW, buf);
    }
